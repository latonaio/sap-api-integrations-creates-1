...
import (
	sap_api_caller "sap-api-integrations-xxxxxx-xxxxxx-creates/SAP_API_Caller"
	sap_api_input_reader "sap-api-integrations-xxxxxx-xxxxxx-creates/SAP_API_Input_Reader"
	"sap-api-integrations-xxxxxx-xxxxxx-creates/config"
...
func main() {
	...
	inputSDC := fr.ReadSDC("./Inputs/SDC_XXXXXXXXX_Header_Item_sample.json")
